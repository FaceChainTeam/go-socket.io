...
[![GoDoc](http://godoc.org/github.com/FaceChainTeam/go-socket.io?status.svg)](http://godoc.org/github.com/FaceChainTeam/go-socket.io) [![Build Status](https://travis-ci.org/FaceChainTeam/go-socket.io.svg)](https://travis-ci.org/FaceChainTeam/go-socket.io)

[![Coverage Status](https://coveralls.io/repos/github/FaceChainTeam/go-socket.io/badge.svg?branch=v1.4)](https://coveralls.io/github/FaceChainTeam/go-socket.io?branch=v1.4)

[![Go Report Card](https://goreportcard.com/badge/github.com/FaceChainTeam/go-socket.io)](https://goreportcard.com/report/github.com/FaceChainTeam/go-socket.io)
...
**Help wanted** This project is looking for contributors to help fix bugs and implement new features. Please check [Issue 192](https://github.com/FaceChainTeam/go-socket.io/issues/192). All help is much appreciated.
...
```bash
go get github.com/FaceChainTeam/go-socket.io
```

Import it with:

```go
import "github.com/FaceChainTeam/go-socket.io"
```
...
import (
	...
	"github.com/FaceChainTeam/go-socket.io"
)
...
<a href="https://github.com/FaceChainTeam/go-socket.io/graphs/contributors">
